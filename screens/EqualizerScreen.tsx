      ...
      <View
        ...
        <View
          ...
          <View
            style={{
              width: 4,
              height: Math.max(2, Math.min(TRACK_HEIGHT, percent * TRACK_HEIGHT)),
              borderRadius: 2,
              backgroundColor: value > 0 ? primaryColor : value < 0 ? '#ef4444' : trackColor,
            }}
          />
        </View>
        <View
          style={{
            ...
            height: 20,
            borderRadius: 10,
            backgroundColor: value > 0 ? primaryColor : value < 0 ? '#ef4444' : mutedColor,
...
export function EqualizerScreen({ visible, onClose }: { visible: boolean; onClose: () => void }) {
  const { primaryColor, textColor, mutedColor, isDarkMode } = useTheme();
  const { gains, preset, enabled, presets, setBandGain, resetToFlat, applyPreset, toggleEnabled } =
    useEqualizerStore();
    ...
    <Modal visible={visible} transparent animationType="slide">
      <View
        ...
        <View
          ...
          <Text style={{ fontSize: 18, fontWeight: '800', color: textColor }}>Equalizer</Text>
          <TouchableOpacity
            ...
            accessibilityLabel={enabled ? 'Disable equalizer' : 'Enable equalizer'}
            accessibilityRole="button"
                      ...
                      backgroundColor:
                        preset === p.name
                          ...
                          : isDarkMode
                            ...
                            : 'rgba(0,0,0,0.06)',
                      borderWidth: 1,
                      borderColor: preset === p.name ? primaryColor : 'transparent',
                    }}>
                    <Text
                      style={{
                        fontSize: 12,
