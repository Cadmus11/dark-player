...
import { CaretLeft, Rewind, FastForward, Play, Pause, MusicNote, VideoCamera, FrameCorners, Square, ArrowsOut, Subtitles, SkipBack, SkipForward, Info, Trash, PictureInPicture, Repeat, Shuffle, MusicNotes, Globe, Check } from 'phosphor-react-native';
