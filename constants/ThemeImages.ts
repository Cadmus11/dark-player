...
const images: Record<string, ThemeImagePreset> = {
  ...
  download: {
    key: 'download',
    name: 'Download',
    source: require('../assets/theme_images/download.jpg'),
  },
  flower: { key: 'flower', name: 'Flower', source: require('../assets/theme_images/flower.jpg') },
  g_wagon: {
    key: 'g_wagon',
    name: 'G-Wagon',
    source: require('../assets/theme_images/g_wagon.jpg'),
  },
  gradient: {
    key: 'gradient',
    name: 'Gradient',
    source: require('../assets/theme_images/gradient.jpg'),
  },
  ...
  porsche: {
    key: 'porsche',
    name: 'Porsche',
    source: require('../assets/theme_images/porsche.jpg'),
  },
  red: { key: 'red', name: 'Red', source: require('../assets/theme_images/red.jpg') },
  samurai: {
    key: 'samurai',
    name: 'Samurai',
    source: require('../assets/theme_images/samurai.jpg'),
  },
